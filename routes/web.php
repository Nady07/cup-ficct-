...
})->middleware(['auth'])->name('dashboard');  // ← QUITÉ 'verified'
...
Route::middleware(['auth', 'role:estudiante'])->prefix('estudiante')->name('estudiante.')->group(function () {
    Route::get('/pago', [EstudianteController::class, 'pago'])->name('pago');    
    ...
    Route::put('/perfil', [EstudianteController::class, 'updatePerfil'])->name('perfil.update');
    Route::post('/requisitos', [EstudianteController::class, 'uploadRequisito'])->name('requisitos.upload');
    Route::post('/requisitos/upload', [EstudianteController::class, 'uploadRequisito'])->name('requisitos.upload');
    Route::post('/pago/upload', [EstudianteController::class, 'uploadPago'])->name('pago.upload');
